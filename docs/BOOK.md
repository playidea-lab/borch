...
> is that **the binding passes 4733 golden cases**, and that is a surface check
...
It passes **4733 golden cases** — every one in the table but eleven. Those eleven
...
covers 4681 cases, and the 53 *it* does not see are this side's alone (1-D and 3-D
...
borch.ts itself has written TS bodies for 4057 cases. **The remaining 687 are two
...
And **4744 golden cases** compare all three implementations against **the same
expected values.** The core covers 4681 cases, leaving out the 53 that are
