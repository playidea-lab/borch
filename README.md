...
> is that **the binding passes 4084 golden cases**, and that is a surface check
...
It passes **4084 golden cases** — every one in the table but eleven. Those eleven
...
covers 4042 cases, and the 53 *it* does not see are this side's alone (1-D and 3-D
...
borch.ts itself has written TS bodies for 3617 cases. **The remaining 478 are two
...
And **4095 golden cases** compare all three implementations against **the same
expected values.** The core covers 4042 cases, leaving out the 53 that are
