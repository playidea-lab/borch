...
> is that **3331 golden cases pass**, and that is a surface check rather than a
...
It passes **3331 golden cases** — every one in the table but five. Those five are
the core's alone: complex eigenvalues, and there is no complex dtype on this side.
The core covers 3283 cases, and the 53 *it* does not see are this side's alone
...
borch.ts itself has written TS bodies for 2822 cases. **The remaining 514 are two
things**: 346 deliberately not carried across, and 168 owed. The binding
...
And **3336 golden cases** compare all three implementations against **the same
expected values.** The core covers 3283 cases, leaving out the 53 that are
