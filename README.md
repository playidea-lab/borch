...
> is that **3348 golden cases pass**, and that is a surface check rather than a
...
It passes **3348 golden cases** — every one in the table but five. Those five are
the core's alone: complex eigenvalues, and there is no complex dtype on this side.
The core covers 3295 cases, and the 53 *it* does not see are this side's alone
...
borch.ts itself has written TS bodies for 2834 cases. **The remaining 514 are two
things**: 348 deliberately not carried across, and 166 owed. The binding
...
And **3348 golden cases** compare all three implementations against **the same
expected values.** The core covers 3295 cases, leaving out the 53 that are
