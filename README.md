...
> is that **the binding passes 4709 golden cases**, and that is a surface check
...
It passes **4709 golden cases** — every one in the table but eleven. Those eleven
...
borch.ts itself has written TS bodies for 4031 cases. **The remaining 689 are two
...
And **4720 golden cases** compare all three implementations against **the same
