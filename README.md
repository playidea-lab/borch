...
> is that **the binding passes 3739 golden cases**, and that is a surface check
...
It passes **3739 golden cases** — every one in the table but five. Those five are
the core's alone: complex eigenvalues, and there is no complex dtype on this side.
The core covers 3691 cases, and the 53 *it* does not see are this side's alone
...
borch.ts itself has written TS bodies for 3287 cases. **The remaining 457 are two
things**: 457 deliberately not carried across, and 0 owed. The binding
...
And **3744 golden cases** compare all three implementations against **the same
expected values.** The core covers 3691 cases, leaving out the 53 that are
