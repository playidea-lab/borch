...
an ES module a browser simply reads (315KB gzipped, 1147KB before compression).
...
borch.ts itself has written TS bodies for 3004 cases. **The remaining 424 are two
things**: 351 deliberately not carried across, and 73 owed. The binding
