...
> is that **the binding passes 3970 golden cases**, and that is a surface check
...
It passes **3970 golden cases** — every one in the table but eleven. Those eleven
...
covers 3928 cases, and the 53 *it* does not see are this side's alone (1-D and 3-D
...
borch.ts itself has written TS bodies for 3504 cases. **The remaining 477 are two
things**: 477 deliberately not carried across, and 0 owed. The binding
...
And **3970 golden cases** compare all three implementations against **the same
expected values.** The core covers 3928 cases, leaving out the 53 that are
