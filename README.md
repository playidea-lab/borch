...
> is that **the binding passes 4581 golden cases**, and that is a surface check
...
It passes **4581 golden cases** — every one in the table but eleven. Those eleven
...
covers 4539 cases, and the 53 *it* does not see are this side's alone (1-D and 3-D
...
borch.ts itself has written TS bodies for 3960 cases. **The remaining 632 are two
...
And **4592 golden cases** compare all three implementations against **the same
expected values.** The core covers 4539 cases, leaving out the 53 that are
