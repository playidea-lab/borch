...
> is that **the binding passes 4199 golden cases**, and that is a surface check
...
It passes **4199 golden cases** — every one in the table but eleven. Those eleven
...
covers 4157 cases, and the 53 *it* does not see are this side's alone (1-D and 3-D
...
borch.ts itself has written TS bodies for 3731 cases. **The remaining 479 are two
things**: 479 deliberately not carried across, and 0 owed. The binding
...
And **4210 golden cases** compare all three implementations against **the same
expected values.** The core covers 4157 cases, leaving out the 53 that are
