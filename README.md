...
> is that **the binding passes 3754 golden cases**, and that is a surface check
...
It passes **3754 golden cases** — every one in the table but five. Those five are
the core's alone: complex eigenvalues, and there is no complex dtype on this side.
The core covers 3706 cases, and the 53 *it* does not see are this side's alone
...
borch.ts itself has written TS bodies for 3288 cases. **The remaining 471 are two
things**: 471 deliberately not carried across, and 0 owed. The binding
...
And **3759 golden cases** compare all three implementations against **the same
expected values.** The core covers 3706 cases, leaving out the 53 that are
