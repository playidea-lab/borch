...
10,337 lines across seven files.
...
> is that **the binding passes 4240 golden cases**, and that is a surface check
...
an ES module a browser simply reads (391KB gzipped, 1423KB before compression).
...
It passes **4240 golden cases** — every one in the table but eleven. Those eleven
...
covers 4198 cases, and the 53 *it* does not see are this side's alone (1-D and 3-D
...
borch.ts itself has written TS bodies for 3770 cases. **The remaining 481 are two
things**: 481 deliberately not carried across, and 0 owed. The binding
...
And **4251 golden cases** compare all three implementations against **the same
expected values.** The core covers 4198 cases, leaving out the 53 that are
