...
> is that **the binding passes 3669 golden cases**, and that is a surface check
...
It passes **3669 golden cases** — every one in the table but five. Those five are
...
borch.ts itself has written TS bodies for 3184 cases. **The remaining 485 are two
