...
from ._ops import (
    ...
    linspace, log, log10, log1p, log2, top_log_softmax as log_softmax, logaddexp, logaddexp2, logdet,
    logical_and, logical_not, logical_or, logit, logsumexp, removed_lstsq as lstsq, lt, manual_seed,
    masked_fill, masked_select, matmul, matrix_exp, matrix_power, removed_matrix_rank as matrix_rank,
    max_pool1d,
    ...
    sign, signbit, silu, sin, sinc, sinh, slogdet, smooth_l1_loss, top_softmax as softmax, removed_solve as solve, sort,
...
_AS_METHOD = (
    ...
    "median", "minimum", "mm", "movedim", "multinomial", "narrow", "narrow_copy",
    "ne", "neg",
