...
| a page with **no build step** (a doc page, a demo, a paper) | `borch-ts` from a CDN | nothing to install | `import { init, Tensor } from "https://cdn.jsdelivr.net/npm/borch-ts@0.6/+esm"` |
